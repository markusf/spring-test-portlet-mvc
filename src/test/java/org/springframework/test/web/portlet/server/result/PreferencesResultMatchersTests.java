 ...
 */
public class PreferencesResultMatchersTests {

	private PreferencesResultMatchers matchers;

	private PortletMvcResult mvcResult;

	@Before
	public void setUp() throws Exception {
		this.matchers = new PreferencesResultMatchers();
		MockActionRequest request = new MockActionRequest();
		request.getPreferences().setValue("key", "value");
		this.mvcResult = new DefaultPortletMvcResult(request, new MockActionResponse());
	}
